                ...
                <form class="form-inline mr-auto" method="POST" action="{{ URL::to('ubah_role') }}">
                    ...
                    <ul class="navbar-nav mr-3">
                        <li><a href="#" data-toggle="sidebar"
                                class="nav-link nav-link-lg collapse-trigger-button"><i
                                    class="text-secondary fas fa-bars text-main"></i></a></li>
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                            class="nav-link notification-toggle nav-link-lg beep"><i
                                class="text-secondary far fa-bell"></i></a>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <div class="d-sm-none d-lg-inline-block text-secondary">{{ auth()->user()->name }}</div>
                        </a>
